	<table id="grid-keep-selection" class="table table-striped table-bordered" data-searchable="false" data-action="<?php echo base_url(); ?>super_admin/employee/employeeattendance/get-table-data">
		<thead>
			<tr> 
				<th data-column-id="employee_attendance_id" data-type="numeric" data-identifier="true" data-visible="false">Sno</th>
				<th data-column-id="employee_id" data-type="numeric" data-identifier="true">Employee ID</th>
				<th data-column-id="full_name" data-identifier="true">Name</th>
				<th data-column-id="attendance" data-formatter="attendancedisplayimg">Effective Hrs</th>
				<th data-column-id="attendance" data-formatter="attendancelog">Log</th>
				<th data-column-id="attendance_date_on" data-converter="datetime">Create On</th>
			</tr>
		</thead>
	</table>
