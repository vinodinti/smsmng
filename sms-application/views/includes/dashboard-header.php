...
<head>
   <meta charset="utf-8" />
   <title><?php echo getPageTitle($this->uri->segment($this->uri->total_segments())); ?></title>
   ...
   <!--start css -->
   <?php $add_css = AccessCSS($this->uri->segment(2));
	if(isset($add_css)) {
		if(is_array($add_css)){
			foreach($add_css as $css)
				echo '<link href="'.base_url().$css.'" rel="stylesheet" type="text/css" />'."\n";
		} else 
			echo '<link href="'.base_url().$add_css.'" rel="stylesheet" type="text/css" />'."\n";
	} 
	?>
	<!--end start css -->
</head>
       ...
       <div class="navbar-inner">
           <div class="container-fluid">
               ...
               <div class="top-nav ">
				...
				<?php /* if(FileExistStatus('storage/employee/photos/'.$this->session->member_photo)){?>
						<img src="<?php echo base_url().'storage/employee/photos/'.$this->session->member_photo; ?>" alt="" style="width:25px; height:25px;">
						   <?php } else { ?>
						<img src="<?php echo base_url().'storage/employee/photos/profile-pic.jpg'; ?>" alt="">
						   <?php } */ ?>
                               
                               <span class="username"><?php echo getMemberEmail(); ?></span>
                               <b class="caret"></b>
                           </a>
